---
name: personal-blog-post-writing
description: Use when drafting, editing, or outlining blog posts, social media articles, or educational medical-scientific content in Dr. Kwo-Ta Chu's personal voice, persuasive style, and dual-lens framework.
---
...
```mermaid
graph TD
    S1["1. 診間真實對話開場\n(Bedside Dialogue Hook)"] --> S2["2. 透視鏡比喻 ➔ 深度科學解密\n(Analogy-First Science Bridge)"]
    S2 --> S3["3. 醫學 AI：醫師的認知副駕駛\n(AI Copilot Positioning)"]
    S3 --> S4["4. 溫暖反思提問 ➔ 診間對話延伸\n(Reflective Ending & Dialogue)"]
```
...
- **核心強調**：AI 大幅提升巨量文檢索與預警效率，但人文關懷、最終決策與溫暖親診依然由醫師把關。
